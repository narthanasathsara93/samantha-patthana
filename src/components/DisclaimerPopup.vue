    ...
    >
      <section class="disclaimer-popup">
        ...
        <div class="disclaimer-popup-message">
          ...
          මෙම යෙදුම ධර්ම දානයක් ලෙස පිරිනමනු ලබන අතර,
          භාවිතා කරන ලද සියලුම මූලාශ්‍ර සහ ඒවායේ කතෘතුමන්ලා සහ ඒවා සකස් කළ පින්වතුන් වෙතද,
          මේ සඳහා නන් අයුරින් ඇප උපකාර කළ සියලුම දෙනාටද විශේෂයෙන් පුණ්‍යානුමෝදනා සිදු කරමු.
          <br />
          <br />
