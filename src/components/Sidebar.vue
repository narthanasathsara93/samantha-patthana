<template>
  <aside :class="['sidebar', { open: isSidebarOpen }]">
    ...
    <div class="sidebar-contact" aria-label="Contact links">
      <a class="contact-link" :href="facebookUrl" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
        title="ෆේස්බුක් ගිණුම">
        <svg class="contact-icon" viewBox="0 2 24 24" aria-hidden="true" focusable="false">
          <path
      ...
      <a class="contact-link" :href="emailHref" aria-label="Email" title="විද්‍යුත් තැපෑල" @click="handleEmailClick">
      ...
      <a class="contact-link" :href="googleFormUrl" target="_blank" rel="noopener noreferrer" aria-label="Google Form"
        title="ඔබේ ප්‍රතිචාර">
        <svg class="contact-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
      ...
      <button class="contact-link" type="button" aria-label="Resources" title="මූලාශ්‍ර වෙත"
