    ...
    steps: [
      {
        ...
        text: `වම් පැති මෙනුවේ හෝ දුරකථන තිරවල ඉහළ ${iconHtml("menu")} මගින් පිවිසී කැමති ප්‍රත්‍යක් තේරිය හැක.`,
      },
      {
        icon: "",
        title: "ප්‍රත්‍යයන් ශ්‍රවණය කිරීමට",
        text: `පහළ ඕඩියෝ ප්ලේයරයේ ${iconHtml("play")} මගින් ආරම්භ කරන්න.<br>
(එක් ගාථාවක් ටච් හෝ ක්ලික් කිරීමෙන්ද එම ගාථා කොටසේ සිට ශ්‍රවණය කළ හැක.)`,
      },
      {
        title: "ඕඩියෝ ප්ලේයරය",
        text: `දුරකථන තිරවල පහළම ${iconHtml("arrow_down")}/${iconHtml("arrow_up")} මගින් ඕඩියෝ ප්ලේයරය දිස්වීම පාලනය කළ හැක.`,
      },
      {
        title: "ස්වයං වාදනය",
      ...
      },
      {
        ...
        text: `දකුණු පස ඉහළ ${iconHtml("sinhala")}/${iconHtml("paali")} මගින් අවශ්‍ය පෙළ පිරික්සීමට හෝ සැඟවීමට හැක.`,
      },
      {
        title: "බුක්මාර්ක් කිරීමට",
        text: `දකුණු පස ඉහළ ${iconHtml("bookmark")} මගින් පසුව නැවත කියවීමට සටහන් කළ හැක.<br>
(ඒවා පැති මෙනුවේ ${iconHtml("bookmarked")}  මගින් සලකුණු වේ.)`,
      },
      {
        title: "අකුරු ප්‍රමාණය වෙනස් කිරීමට ",
        text: `දකුණු පස ඉහළ ${iconHtml("font_resize")} මගින් ඔබට පහසු ලෙස අකුරු විශාලත්වය වෙනස් කළ හැක.`,
      },
      {
...
${iconHtml("diamond1")} මගින් භාවිත කළ මූලාශ්‍ර පරිශීලනය කළ හැක.<br>`,
  ...
  },
  {
    ...
    title: "ස්වයං පුහුණුව",
    description:
      "ඔබට අවශ්‍ය පුහුණු මට්ටමක් තෝරාගෙන සඟවා ඇති වචන මතකයෙන් ආවර්ජනය කරමින් පුහුණුවෙහි නිරත විය හැක.",
    steps: [
      {
        title: "අසීරුතා මට්ටමක් තෝරා ගැනීම",
        text: "ඔබේ ප්‍රවීණතාවය අනුව ආධුනික, මධ්‍යස්ථ, ප්‍රවීණ යන මට්ටම් 3ක් යටතේ තේරිය හැක.",
      },
      {
        title: "පුහුණු ආකාරය සැකසීම.",
        text: `මෙය ප්‍රත්‍යයන් අහඹු ලෙස හෝ අනුපිළිවෙලින් දිස් වන ආකාරයටද ඇරඹිය හැක.<br>
ටයිමරය මගින්  ඔබට සුදුසු කාලයක් මිනිත්තු වලින්  පුහුණුව සඳහා පනවා හෝ නොපනවා භාවිත කළ හැක.<br>
සැකසූ කාලය අවසන් වූ විට ස්වයංව පුහුණුව අවසන් වනු ඇත.`,
      },
      {
        title: "පාලක අයිතම",
